...
## Einführung
In diesem Kapitel verwenden wir die Begriffe AI, KI, genAI und genKI als Synonym für generative KI.

## KI in der Entwicklung

Aktuell ist das Thema KI ein Hypethema. Produkte/Lösungen wie ChatGPT,  Microsoft Copilot, Google GEMINI und SAP Joule werden überall diskutiert und finden in Lösungen ihre praktische Anwendung. Auch in der Softwareentwicklung werden diese Lösungen eingesetzt, sogar in der ABAP Entwicklung gibt es entsprechende KI Unterstützung, diese steckt zwar noch in den „Kinderschuhen“, aber es gibt diese schon, die Lösungen werden allerdings stetig weiterentwickelt, so dass diese bald aus den "Kinderschuhen" entwachsen werden.

Was hier in der Zukunft noch kommen wird ist sehr spannend und aktuell nicht vorhersehbar. In diesem Kapitel wollen wir allgemeine Hilfestellungen für eine Entscheidungsfindung für die Nutzung/Anwendung von KI Lösungen in der Softwareentwicklung geben. Wir wollen bewusst nicht die eine oder andere Softwarelösung vorstellen oder bewerten.
...
- Welche Sicherheitsanforderungen werden an die KI gestellt?
    - Private Space vs. Public Space
        ...
        - Public Space: KI-Systeme und -Daten sind für die breite Öffentlichkeit zugänglich wo ist hier die Datenhaltung - in der EU?
...
- Werden Third-Party KI Produkte verwendet, ja ja welche?
...
- Was ist der Inhalt? Wie passt dieser auf die eigene Unternehmenskultur oder gar mit dem eigenen KI Ethik Fundament?

Neben den oben genannten Fragestellungen birgt der Einsatz von KI auch Themen-/Problemfelder wie man mit ethischen Bedenken der aus den Trainingsdaten übernommene „Voreingenommenheit“ von KI Modellen (Schlagworte sind hier AI BIAS, KI BIAS) umgeht bzw. wie man diese begegnet/entgegnet? 
...
Zentrale Komponente ist “SAP Joule“, für die Integration der einzeln Modelle dient die „AI Foundation“ auf der BTP. Dies ist auch die Basis für die technische Verfügungsstellung der KI Unterstützung für ABAP.

Geplant sind bei SAP aktuell drei Bereiche der Unterstützung im ABAP Entwicklungsumfeld:
...
Bis sich KI im Alltag des ABAP Entwicklers dauerhaft und voll integriert wiederfindet, wird sicher noch einige Zeit vergehen. Allerdings kann KI bereits jetzt unterstützend ohne technische Integration sinnvoll im Entwickleralltag eingesetzt werden.
...
Als erstes Ergebnis erhält man hier eine Beschreibung was die KI aus dem Code und den Informationen auswerten konnte. Hier wird schnell offensichtlich inwiefern der Code die gewünschte Logik erklärbar umsetzt und wo iterationen und manuelle Korrekturen und Ergänzungen notwendig sind.
...
Ob man am Ende schneller ist, kommt auf die Anwendung und die Beherrschung der KI an. Aber der schwierige Schritt des Anfangs ist deutlich einfacher und die gewonnene Zeit kann investiert werden eine qualitativ hochwertige Dokumentation zu erstellen.
